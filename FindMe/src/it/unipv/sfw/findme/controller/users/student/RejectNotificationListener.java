...
public class RejectNotificationListener implements ActionListener{
	...
	public RejectNotificationListener(JList<JoinGroupNotification> list, Users user, UserGUI frame) {
		this.list = list;
		this.user = user;
		this.frame = frame;
	}
	...
	public void actionPerformed(ActionEvent e) {
    	...
    	tempFrame.repaint();
    	new ExceptionFrame("Invite Rejected!");	
