package it.unipv.sfw.findme.model.users.professor;
...
import it.unipv.sfw.findme.view.users.professor.ProfessorGUI;
import it.unipv.sfw.findme.view.users.professor.ProfessorMainPanel;
import it.unipv.sfw.findme.view.users.professor.ProfessorNotificationPanel;  
...
public class Professor extends Users{
	...
	public void swapSchedule(ProfessorNotification notification) throws Exception{
		ProfessorNotificationDAO profDAO=new ProfessorNotificationDAO();
