package it.unipv.sfw.findme.view.booking;
...
import it.unipv.sfw.findme.controller.booking.ConfirmBookingAL;
...
public class ConfirmBookigPanel extends JPanel{
	...
	public ConfirmBookigPanel(JList<Booking> roomsList, Users user, UserGUI frame) {
		...
		bookingButton.addActionListener(new ConfirmBookingAL(list, maxed, frame, user));
