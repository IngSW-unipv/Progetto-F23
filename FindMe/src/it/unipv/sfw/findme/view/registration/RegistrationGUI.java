...
import it.unipv.sfw.findme.controller.registration.RegistrationActionListener;
import it.unipv.sfw.findme.model.email.GenerateRandom;
import it.unipv.sfw.findme.model.enums.UserType;
...
import it.unipv.sfw.findme.view.login.PanelLogo;
...
class MainPanel extends JPanel{ 
	...
	public MainPanel(RegistrationGUI frame) {
		...
		RegistrationActionListener registerListener=new RegistrationActionListener(nameField.getText(), lastNameField.getText(), idNumberField.getText(), emailField.getText(), (String)emailSelect.getSelectedItem(), passwordField.getPassword(), confirmPasswordField.getPassword(), userTypeSelect.getSelectedItem().toString(), frame);
