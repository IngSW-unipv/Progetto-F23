...
import it.unipv.sfw.findme.controller.users.admin.AddCourseListener;
...
public class AddCoursePanel extends JPanel{
	...
	public AddCoursePanel(UserGUI frame) {
		...
		AddCourseListener addCourse=new AddCourseListener(courseFullNameField, yearsSelect, courseCodeFiled, frame);
		addButton.addActionListener(addCourse);
		c.gridx=1;
		c.gridy=3;
		add(addButton, c);
		//
