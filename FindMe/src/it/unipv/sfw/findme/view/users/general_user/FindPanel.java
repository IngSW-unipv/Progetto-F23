...
import it.unipv.sfw.findme.controller.users.general_user.MonthComboBoxListener;
import it.unipv.sfw.findme.controller.users.general_user.SearchButtonListener;
import it.unipv.sfw.findme.controller.users.general_user.TimeSpanListener;
import it.unipv.sfw.findme.controller.users.general_user.YearComboBoxListener;
...
public class FindPanel extends JPanel{
	...
	public FindPanel(UserGUI userMainGUI, Users user) {
		...
		//c.gridy=2;
		//
		MonthComboBoxListener ml=new MonthComboBoxListener(this.monthsSelect, this.leapYear, this.daysSelect, this.monthsSelect);
		monthsSelect.addActionListener(ml);
		add(monthsSelect, c);
		
		YearComboBoxListener yl=new YearComboBoxListener(this.allMonths, this.monthsSelect, yearsSelect);
		...
		TimeSpanListener sl=new TimeSpanListener(startTimeBox, endTimeBox);
		...
		SearchButtonListener sbl=new SearchButtonListener(yearsSelect, monthsSelect, daysSelect, startTimeBox, endTimeBox, userMainGUI, user);
