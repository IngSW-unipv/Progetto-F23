...
import it.unipv.sfw.findme.controller.users.professor.SendDraftListener;
...
public class SendDraftFrame extends JFrame{
	...
	public SendDraftFrame(ProfessorNotification notification, Users user, UserGUI frame) {
		...
		try {
			...
			SendDraftListener sendDraft=new SendDraftListener(roomsBox, notification, datePanel, startTimeBox, endTimeBox, user, frame, this);
			send.addActionListener(sendDraft);
			c.gridx=2;
			c.gridy=1;
